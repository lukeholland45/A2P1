# Generated by Django 2.0.6 on 2018-06-09 21:23
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='investments', to='portfolio.Customer')),
            ],
        ),
        migrations.CreateModel(
            name='Stock',
            fields=[
                ...
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='stocks', to='portfolio.Customer')),
            ],
        ),
    ]
